...
selected_indices <- sample(1:total_points, 79)
grid_coords <- expand.grid(x = 1:grid_size, y = 1:grid_size)
sim_coords <- grid_coords[selected_indices, ] 
...
# simulate spatil extremes dataset
...
shape.form1 <- shape ~ 1
# fix seven parameters, estimate the covariance parameters
...
full_vcov[1:3, 1:3] <- 2 * mod.spe1$var.cov 
